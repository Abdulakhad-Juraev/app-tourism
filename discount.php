            ...
            <div class="row h-100 align-items-center">
                <div class="col-12">
                    <div class="breadcrumb-content text-center">
                        <h2 class="page-title"><?= $local_strings[$lang]['d1']; ?></h2>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb justify-content-center">
                                <li class="breadcrumb-item"><a href="index.php"><?= $local_strings[$lang]['b2']; ?></a></li>
                                <li class="breadcrumb-item active" aria-current="page"><?= $local_strings[$lang]['d1']; ?></li>
                            </ol>
                        </nav>
                    </div>
                </div>
                    ...
                    while ($q = mysqli_fetch_array($r, MYSQLI_ASSOC)) {
                        ...
                        <div class="single-blog-post d-flex align-items-center mb-50 wow fadeInUp"
                            ...
                            <div class="post-thumbnail">
                                <a href="#"><img src="./uploads/<?= $q['photo']; ?>" alt=""></a>
                            </div>
                            ...
                            <div class="post-content">
                                ...
                                <h4><del style="color: red"><?= $q['narx'];?></del> <span style="font-size: 30px;color: #1cc3b2;"><?
                                        $a1 = ($q['narx']/100)*$q['chegirma'];
                                        echo $q['narx']-$a1;
                                        ?></span></h4>
                                <a href="#" class="post-title"><?= $q['name_'.$lang]; ?></a>
                                <?= substr($q['content_'.$lang], 0, 200) . "..."; ?>
                                <br>
                                <a href="discount-detail.php?did=<?=$q['id'];?>" class="btn continue-btn"><?= $local_strings[$lang]['b9']; ?></a>
                            </div>
                        </div>
