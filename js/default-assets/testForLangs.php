...
include_once './../../langs/' . $_SESSION['l'] . ".php";
    ...
    (function ($) {
        ...
        if ($.fn.owlCarousel) {
            ...
            roomSlides.owlCarousel({
                ...
                smartSpeed: 1500,
                nav: true,
                navText: [('<i class="fa fa-long-arrow-left" aria-hidden="true"></i> <?=$data['d2'];?>'), ('<?=$data['d2'];?> <i class="fa fa-long-arrow-right" aria-hidden="true"></i>')]
            });
